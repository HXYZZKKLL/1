...
# 定义路径
train_dir = r"C:\Users\86158\Desktop\phone\train"
test_dir = r"C:\Users\86158\Desktop\phone\test_A_images"
...
if __name__ == "__main__":
    ...
    # 保存模型
    torch.save(model.state_dict(), r"C:\Users\86158\Desktop\phone\resnet18.pth")

    # 加载模型
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    model.load_state_dict(torch.load(r"C:\Users\86158\Desktop\phone\resnet18.pth"))
    ...
    # 保存预测结果到 CSV 文件
    output_path = r"C:\Users\86158\Desktop\phone\test_predictions.csv"
